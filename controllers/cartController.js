...
exports.addToCart = async (req, res) => {
    try {
        ...
        if (existingProduct) {
            ...
            {
                console.log(`There are ${product.quantity - quantity} other items left in stock` );
                return res.status(400).json({ message: `There are ${product.quantity - quantity} other items left in stock` });
